    ...
    def update(self):
        ...
        for count, channel in enumerate(self.exg_channels):
            ...
            DataFilter.remove_environmental_noise(
                data[channel], self.sampling_rate, NoiseTypes.SIXTY.value)
            DataFilter.remove_environmental_noise(
                data[channel], self.sampling_rate, NoiseTypes.FIFTY.value)
            ...
            if data.shape[1] > self.psd_size:
                ...
                avg_bands[0] = avg_bands[0] + \
                    DataFilter.get_band_power(psd_data, 1.0, 4.0)
